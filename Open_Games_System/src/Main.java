...
//    static public double resolutionY = Screen.getPrimary().getBounds().getMaxY() * 0.7;
    ...
    static public double resolutionSnakeX = Screen.getPrimary().getBounds().getMaxX() * 0.5;
    static public double resolutionSnakeY = Screen.getPrimary().getBounds().getMaxY() * 0.7;
